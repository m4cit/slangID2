...
file_path = './classifiers/modifiers/data/handpicked_data.csv'
...
nbg_label = tk.Label(frame, text="Naive Bayes (Gaussian)", bg="white", font=("Calibri", 11),relief="ridge")
nbg_label.place(width=200, height=50, x=20, y=282)

nbm_label = tk.Label(frame, text="Naive Bayes (Multinomial)", bg="white", font=("Calibri", 11),relief="ridge")
...
entry_label = tk.Label(frame, bg="#a0a0a0", fg="white", text="Give me a phrase", font=("Calibri", 14, "bold"))
entry_label.place(x=20, y=23)
#################################################################################################################################
...
clear_button = tk.Button(root, command=lambda: clear(), text="CLEAR OUTPUT", fg="black", bg="#bf0606", font=("Calibri", 12,"bold"), padx=5, pady=5, relief="raised")
...
preprocess_button = tk.Button(root, command=lambda: pp(file_path), text="preprocess data", fg="black", bg="#00caf3", font=("Calibri", 10,"bold"), padx=5, pady=5, relief="raised")
preprocess_button.place(anchor="ne", width=140, height=60, x=155, y=370)
################################################################################################################################
